...
class PaymentPage {
    constructor(driver) {
        ...
        this.componentPayment = By.xpath('//button[@data-test-id="CT_Component_PaymentGroup_ButtonPaymentGroup"]');
        this.selectPayment = By.xpath('//div[@data-test-id="CT_Component_SelectorPayment_ButtonSelectBank_VABCA"]');
